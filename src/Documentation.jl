...
_brief_docs = Dict{Symbol, String}(
    ...
    :semion_fr_data => "    semion_fr_data()\n\nReturn built-in exact semion F/R data.",
    :fibonacci_fr_data => "    fibonacci_fr_data()\n\nReturn built-in exact Fibonacci F/R data.",
    :ising_fr_data => "    ising_fr_data()\n\nReturn built-in exact Ising F/R data.",
