...
"""
    generated_matrix_algebra(sigmas, p; max_dimension = nothing)

Experimental API.

Compute the finite-field matrix algebra generated by `sigmas` modulo `p`.
The output is a `MatrixAlgebraDiagnostics` record containing the computed
basis dimension, ambient dimension, basis matrices, and truncation status.
