...
The documentation work concentrates on exported docstrings, Documenter pages,
...
| Area | Stable public API | Semi-public low-level API | Experimental/internal exported API | Notes |
| --- | --- | --- | --- | --- |
...
The docstring inventory checks exported bindings with
...
- Low-level search and reconstruction helpers remain exported for backward
